...
<div class="row footer ">
        ...
        <div class="col-xl-2 col-md-3 ">
            ...
            <ul class = "footer-tag">
                <li><a href="../Client/vechungtoi.php">Về chúng tôi</a></li>
                <li class="mt-2"><a href="">Liên hệ</a></li>
                <li class="mt-2"><a href="../Client/chinhsachbaomat.php">Chính sách bảo mật</a></li>
            </ul>
        </div>
